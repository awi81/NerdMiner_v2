...
def create_merged_firmware(source, target, env):
    ...
    try:
        ...
        print(f"OK Firmware: {update_file.name}")
    except Exception as e:
    ...
    try:
        ...
        print(f"OK Factory: {factory_file.name} ({actual_end} bytes)")
